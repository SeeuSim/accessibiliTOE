    ...
    <div className="h-full w-screen bg-slate-100 flex items-center justify-center">
      <form className="w-4/5 sm:w-2/3 bg-white h-screen">
        ...
        <div className="flex flex-col">
          <div className="pl-4 py-5 flex flex-row">
            <div className="w-5/12 flex flex-col">
              <label className="font-bold text-xl mb-4">First Name:</label>
              <input 
            ...
            <div className="w-5/12 flex flex-col">
              <label className="font-bold text-xl mb-4">Last Name:</label>
              <input 
                className="w-11/12 h-12 text-3xl bg-slate-100 text-slate-900 border border-slate-500"
                type="text"
                required={true}
          ...
          <div className="pl-4 py-5 flex flex-col">
